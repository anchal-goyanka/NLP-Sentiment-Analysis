...
class NaiveBayes:
  ...
  def __init__(self):
    ...
    #self.stopList = set(self.readFile('../data/wos.txt'))    #using words from "wos.txt"
  ...
  def addExample(self, klass, words):
    ...
    #Considering only once every word in each document
    ''''
    ...
    #Replacing all the words after never, not and n't as NOTword
    '''
    match = '(\w+)n\'t'
    i = 0
    while i< len(words) :
